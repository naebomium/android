...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private final Bitmap thumbImage = BitmapFactory.decodeResource(getResources(), R.drawable.handle_on);
    private final Bitmap thumbPressedImage = BitmapFactory.decodeResource(getResources(), R.drawable.handle_on);
     ...
     */
    public static int DEFAULT_COLOR = Color.YELLOW;
    ...
    private final void init() {
        ...
        DEFAULT_COLOR = getResources().getColor(R.color.application_color_accent);
    }

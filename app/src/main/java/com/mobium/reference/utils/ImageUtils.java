...
public final class ImageUtils {
    ...
    public static boolean isImageVertical(String fileName) {
        String exifOrientation = getOrientationTag(fileName);
        return !"0".equals(exifOrientation) && !"1".equals(exifOrientation) && !"2".equals(exifOrientation) && !"3".equals(exifOrientation) && !"4".equals(exifOrientation);
    }
    ...
    public static Bitmap fixRotation(Bitmap bmp, Uri uri, Context context) throws OutOfMemoryError {
        if (bmp == null) {
            return null;
        }
    ...
    public static Bitmap fixExifRotation(Bitmap bmp, String exifFileName) throws OutOfMemoryError {
        if (bmp == null)
            return null;

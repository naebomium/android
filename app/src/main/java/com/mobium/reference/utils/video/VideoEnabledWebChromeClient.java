package com.mobium.reference.utils.video;
...
public class VideoEnabledWebChromeClient extends WebChromeClient implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener
{
    ...
    private boolean isVideoFullscreen; // Indicates if the video is being displayed using a custom_icon view (typically full-screen)
    ...
    /**
     * Set a callback that will be fired when the video starts or finishes displaying using a custom_icon view (typically full-screen)
